...
class CustomerDeclinedBookings extends StatefulWidget {
  const CustomerDeclinedBookings({Key? key}) : super(key: key);

  @override
  State<CustomerDeclinedBookings> createState() =>
      _CustomerDeclinedBookingsState();
}

class _CustomerDeclinedBookingsState extends State<CustomerDeclinedBookings> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: FutureBuilder(
        future: _bookingsController.getCustomerBookingsById("declined"),
