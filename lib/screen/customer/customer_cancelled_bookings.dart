...
class CustomerCancelledBookings extends StatefulWidget {
  const CustomerCancelledBookings({Key? key}) : super(key: key);

  @override
  State<CustomerCancelledBookings> createState() =>
      _CustomerCancelledBookingsState();
}

class _CustomerCancelledBookingsState extends State<CustomerCancelledBookings> {
