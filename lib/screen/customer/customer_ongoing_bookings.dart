...
class CustomerOngoingBookings extends StatefulWidget {
  const CustomerOngoingBookings({Key? key}) : super(key: key);

  @override
  State<CustomerOngoingBookings> createState() =>
      _CustomerOngoingBookingsState();
}

class _CustomerOngoingBookingsState extends State<CustomerOngoingBookings> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: FutureBuilder(
        future: _bookingsController.getCustomerBookingsById("in-progress"),
