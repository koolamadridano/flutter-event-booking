...
class CustomerCompletedBookings extends StatefulWidget {
  const CustomerCompletedBookings({Key? key}) : super(key: key);

  @override
  State<CustomerCompletedBookings> createState() =>
      _CustomerCompletedBookingsState();
}

class _CustomerCompletedBookingsState extends State<CustomerCompletedBookings> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: FutureBuilder(
        future: _bookingsController.getCustomerBookingsById("completed"),
