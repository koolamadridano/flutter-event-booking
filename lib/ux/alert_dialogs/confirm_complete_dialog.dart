...
Future<Null> dialogIsEventFinished(
    {required BuildContext context, action}) async {
  final BookingsController _bookingsController = Get.put(BookingsController());

  Future<void> handleConfirmFinished() async {}
                  ...
                  SizedBox(
                    ...
                    child: RichText(
                      text: TextSpan(
                        ...
                        children: [
                          TextSpan(
                            text: _bookingsController
                                .evpSelectedActiveBooking["event"]["title"],
                            style: GoogleFonts.roboto(
                              color: secondary,
